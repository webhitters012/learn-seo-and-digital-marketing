  ...
  return (
    <div>
      ...
      <div className="container mt-5">
        <div className="row">
          {/** Course 1 */}
          <div className="col-md-4 d-flex align-items-center justify-content-center img1-div-of-price position-relative w-100">
            <img className="d-block p-1" style={{ width: '30%' }} src="Images/Courses/Digital Marketing Courses in Zirakpur.png" alt="Digital Marketing Courses in Zirakpur" />
            <button className="enrol-button" onClick={openPopup}>Enroll Now</button>
          </div>

          {/** Course 2 */}
          <div className="col-md-4 d-flex align-items-center justify-content-center img1-div-of-price position-relative w-100">
            <img className="d-block p-1" style={{ width: '30%' }} src="Images/Courses/SEO Training in Zirakpur.png" alt="SEO Training in Zirakpur" />
            <button className="enrol-button" onClick={openPopup}>Enroll Now</button>
          </div>

          {/** Course 3 */}
          <div className="col-md-4 d-flex align-items-center justify-content-center img1-div-of-price position-relative w-100">
            <img className="d-block p-1" style={{ width: '30%' }} src="Images/Courses/Graphic Designing and Web Designing.png" alt="Graphic Designing and Web Designing" />
            <button className="enrol-button" onClick={openPopup}>Enroll Now</button>
          </div>
        </div>
      </div>
          ...
          <div className="popup-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <img src="Images/popup img.jpg" height="450px" width="320px" alt="Popup Image" />
              </div>
            </div>
          </div>
        </div>
